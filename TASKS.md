...
- [Extract version string into a constant](tasks/cq-version-constant.md)
- [Pass FredOptions struct to apply_fred_options](tasks/cq-fred-options-struct.md)
- [Extract broken-bar character into a named constant](tasks/cq-broken-bar-constant.md)
- [Remove unused _apriori parameter from apply_fred_options](tasks/cq-remove-unused-apriori.md)
- [Extract apriori parsing helper in lib.rs](tasks/cq-apriori-helper.md)
- [Break up long formatting functions](tasks/cq-long-functions.md)

### Web

- [Extract shared DownloadButton component](tasks/cq-download-button.md)
- [Use useLocalStorage hook consistently in App.tsx](tasks/cq-app-localstorage.md)
- [Extract responsive breakpoint constants](tasks/cq-breakpoint-constants.md)
